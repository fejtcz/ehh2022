 ...
 * - PubSubClient Library 2.8.0
 * - ArduinoJSon Library 5.1.0
...
RTC_SLOW_ATTR static MQTT_Glucose mqtt_glucose={0};
RTC_SLOW_ATTR static MQTT_Battery mqtt_battery={0};
...
void mqtt_callback(char* topic, byte* message, unsigned int length) {
  ...
  //TODO: In the future for setting transmitter id
}
